...
This document will be used to contain *links to specialised iOS libraries* coded by respective third-party developers using either **Objective-C** or **Swift** for future needs..   
...
- [YLLongTapShare](https://github.com/liyong03/YLLongTapShare)
...
- [SparkRecordingCircle](https://github.com/subjc/SparkRecordingCircle)
...
- [UIAutoMonkey](https://github.com/jonathanpenn/ui-auto-monkey)
...
- [BMAGridPageControl](https://github.com/badoo/BMAGridPageControl)

#### Navigation Menu

- [IIViewDeckController](https://github.com/ViewDeck/ViewDeck)
...
- [ContextMenu](https://github.com/Yalantis/Context-Menu.iOS)
...
- [RobbHamburgerMenu](https://github.com/robb/hamburger-button)
- [LBHamburgerButton](https://github.com/luongbang152/HamburgerButton)
...
- [IFGZoomCollectionViewLayout](https://github.com/ifullgaz/IFGZoomCollectionViewLayout)

#### Drawing

- [KZLineDrawer](https://github.com/krzysztofzablocki/KZLineDrawer)
...
- [M14ProgressSuite](https://github.com/Marxon13/M13ProgressSuite)
- [SpinKit-ObjC](https://github.com/raymondjavaxx/SpinKit-ObjC)

#### Image

- [GPUImage](https://github.com/BradLarson/GPUImage)
- [CRPixellatedView](https://github.com/chroman/CRPixellatedView)
- [FFAngularPointilism](https://github.com/Showtimes/FFAngularPointilism)
- [UIImageView+Letters](https://github.com/bachonk/UIImageView-Letters)

#### Label

- [YetiCharacterLabelExample](https://github.com/android1989/YetiCharacterLabelExample)
- [PreloaderOphiuchus](https://github.com/Yalantis/Preloader.Ophiuchus)
...
- [MGConferenceDatePicker](https://github.com/matteogobbi/MGConferenceDatePicker)
- [THCalendarDatePicker](https://github.com/hons82/THCalendarDatePicker)
- [PDTSimpleCalender](https://github.com/jivesoftware/PDTSimpleCalendar)
...
- [PullToRefreshRentals](https://github.com/Yalantis/Pull-to-Refresh.Rentals-iOS)
- [PullToMakeSoup](https://github.com/Yalantis/PullToMakeSoup)
- [STZPullToRefresh](https://github.com/STAR-ZERO/STZPullToRefresh)

#### ScrollView

- [PWParallaxScrollView](https://github.com/wpsteak/PWParallaxScrollView)
- [DVOMarqueeView](https://github.com/mobitar/DVOMarqueeView)
- [DRPageScrollView](https://github.com/DavdRoman/DRPageScrollView)
...
- [MTZWhatsNew](https://github.com/mdznr/What-s-New)
- [AMPopTip](https://github.com/andreamazz/AMPopTip)
- [DBPrivacyHelper](https://github.com/danielebogo/DBPrivacyHelper)
...
- [NSString+EmailAddresses](https://github.com/melsam/NSString-EmailAddresses)
...
- [BKZoomView](https://github.com/freshking/BKZoomView)
...
- [Star-Wars-Transition](https://github.com/Yalantis/StarWars.iOS)
- [Koloda-Tinder-Like](https://github.com/Yalantis/Koloda)
- [Eat-Fit](https://github.com/Yalantis/EatFit)
- [Appearance-Navigation-Controller](https://github.com/Yalantis/AppearanceNavigationController)
- [Awesome-Swift-Education](https://github.com/hsavit1/Awesome-Swift-Education)

#### SDK Features

- [ShinobiControls-iOS8](https://github.com/ShinobiControls/iOS8-day-by-day)
...
- [URBMediaFocusViewController](https://github.com/u10int/URBMediaFocusViewController)

#### Navigation Menu

- [FrostedSidebar](https://github.com/edekhayser/FrostedSidebar)
- [GuillotineMenu](https://github.com/Yalantis/GuillotineMenu)
- [SideMenu](https://github.com/Yalantis/Side-Menu.iOS)
...
- [PullToRefresh](https://github.com/Yalantis/PullToRefresh)
- [PullToMakeFlight](https://github.com/Yalantis/PullToMakeFlight)

#### ScrollView-Based-View
...
- [PMKObserver](https://github.com/postmates/PMKVObserver)
...
- [Gaming](https://github.com/ellisonleao/magictools)
